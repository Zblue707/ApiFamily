...
public class Integrante {
	...
	@Column(name = "id_usuario_google")
	private Long idUsuarioGoogle;
	...
	public Long getIdUsuarioGoogle() {
		return idUsuarioGoogle;
	}

	public void setIdUsuarioGoogle(Long idUsuarioGoogle) {
